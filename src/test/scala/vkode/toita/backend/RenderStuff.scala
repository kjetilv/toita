...
class RenderStuff {
  ...
  @Test def renderMentionHashes {
    ...
    val tsu = Rendrer render (List(TwitterStatusUpdate(TOStatus(10,
                                                                text,
                                                                false,
                                                                Some("foo"),
                                                                false,
  ...
  @Test def renderCivix {
    val tsu = Rendrer render (List(TwitterStatusUpdate(TOStatus(BigInt("16483093779062784", 10),
  ...
  @Test def renderUrl {
    val tsu = Rendrer render (List(TwitterStatusUpdate(TOStatus(BigInt("16469778663211008", 10),
  ...
  @Test def renderSjetilv {
    val tsu = Rendrer render List(TwitterStatusUpdate(TOStatus(BigInt("16453482592600065", 10),
  ...
  private def parseAndRender(json: String): Unit = {
    ...
    val nodes = Rendrer render event
